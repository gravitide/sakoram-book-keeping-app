...
// Font cascade: the user's chosen PDF font (data.font_family) is tried
...
// business name set as a typographic wordmark so the header isn't
// blank when no logo has been uploaded.
#align(right)[
